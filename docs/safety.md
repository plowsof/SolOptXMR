...
- an instability between the input MPPT controller and the batteries, leading to a slowdown of its reactions, hence instability of the voltage reaching the inverter, that may cause it's short, but complete resets
